                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      return Shingle(
                          ...
                          type: 'goal',
                          title: double.parse( widget.dataSet[3][index+1])>0
                              ? '${DefaultValues.messages['recomm_positive_1']} ${DefaultValues.messages['recomm_2']} ${widget.dataSet[0][index+1]} '
                          :'${DefaultValues.messages['recomm_negative_1']} ${DefaultValues.messages['recomm_2']} ${widget.dataSet[0][index+1]}',
