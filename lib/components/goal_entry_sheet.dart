              ...
              child: Wrap(
                children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            CommandButton(
                              ...
                              onPressed: () {
                                var goal = Goal(
                                  name: goalIcons.containsKey(this
                  ...
                  widget.type == 'Delete'
                      ? Utility.showBanner(
                          context,
                          DefaultValues.messages['warning_deletion']!,
                          Colors.red.shade50,
                          Colors.red)
                      : SizedBox(
                          width: 0,
                  ...
                  Row(
                    children: [
                      Container(
                          height: 22
                              .h, //* DefaultValues.adaptForSmallDevice(context),
                          width: 22
                              .h, // * DefaultValues.adaptForSmallDevice(context),
                      ...
                      Container(
                        height: 22
                            .h, //* DefaultValues.adaptForSmallDevice(context),
                        width: 22
                            .h, //* DefaultValues.reduceWidthAsPerScreen(context),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            SizedBox(
                              height: 3.h,
                            ), // * DefaultValues.adaptForSmallDevice(context),),
                            Row(
                              children: [
                                Container(
                                    height: 1.5
                            ...
                            Align(
                                ...
                                child: Text(
                                  (goalAmount + inflationEffect) <
                                          DefaultValues.threshold
                                      ? '${DefaultValues.textFormat.format(inflationEffect)}'
                            ...
                            Align(
                              ...
                              child: Text(
                                (goalAmount + inflationEffect) <
                                        DefaultValues.threshold
                                    ? '${DefaultValues.textFormat.format(goalAmount + inflationEffect)}'
                    ...
                    child: LabeledInput(
                      ...
                      onCompleteEditing: () {
                        setState(() {
                          ...
                          goalController.text = DefaultValues.textFormat
                              .format(double.parse(goalController.text));
                        });
                      },
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: (widget.type != 'Delete')
                        ? LabeledSlider(
                            ...
                            labelText:
                                DefaultValues.titles['goal_period_title']!,
